...
const KuberenetesClient = require('./kuberenetes-client');
...
class GcpSdkClient
{
    ...
    {
        this._logger.silly('[connectToKubernetes] Cluster: ', cluster);
        ...
        return this._loginToK8s()
            .then(result => {
                ...
                return new KuberenetesClient(this._logger, config);
            });
    }
