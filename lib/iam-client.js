...
class IamClient extends BaseClient
{
    ...
    {
        var options = {
            uri: `https://cloudresourcemanager.googleapis.com/v1/projects/${this.projectId}:getIamPolicy`,
            method: 'POST'
        }
    ...
    setProjectIamPolicy(bindings)
    {
        var options = {
            uri: `https://cloudresourcemanager.googleapis.com/v1/projects/${this.projectId}:setIamPolicy`,
            method: 'POST',
            body: {
                policy: {
                    bindings: bindings
